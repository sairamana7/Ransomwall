...
<div id="leftMain">
<h2><font color="#0066FF">Ransome User Login Here</font></h2>
 <form name="f1" action="RansomeUserLoginCheck" method="post"   >
                                <table>
                                    <tr>
                                        <td>Login Name </td>
                                 ...
                                 <%
                                    ...
                                    if (msg != null && msg.equalsIgnoreCase("success")) {
                                        out.println("<font color='BLUE'>Login Successfull</font>");
                            ...
                            <h4>If Not Registerd Please Registered <a class="banner_btn" href="RansomeuserRegister.jsp">Here</a></h4>
