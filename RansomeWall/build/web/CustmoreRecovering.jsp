...
<div id="headerlinks"> 
	...
	<a href="CustViewFiles.jsp" target="_parent" class="hlinks">View File &nbsp;&nbsp;</a>    
...
<%  
 String ransomFileid = request.getParameter("ransomFileid");
 String ransomeFileName = request.getParameter("ransomeFileName");
 String filetype = request.getParameter("filetype");
 
 
%>
 <form name="f1" action="DataUserFileRecovering" method="get">
                                <table>
                                    <tr>
                                        <td>Ransome File Id </td>
                                        <td><input type="text" name="ransomFileid" value="<%=ransomFileid%>" readonly ></td>
                                    </tr>
                                    <tr>
                                        <td>Ransome File Name </td>
                                        <td><input type="text" name="ransomeFileName" size="40" value="<%=ransomeFileName%>" readonly=""></td>
                                    </tr>
                                    <tr>
                                        <td>Ransome File Type </td>
                                        <td><input type="text" name="filetype" value="<%=filetype%>" readonly ></td>
                                    </tr>
                                    <tr>
                                        <td>Enter Recover Key </td>
                                        <td><input type="text" name="recoverkey" required="" ></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td><input type="submit" value="Recover" class="btn">
                                    </tr>
                                </table>
                                 <%
                                    String msg = request.getParameter("msg");
                                    if (msg != null && msg.equalsIgnoreCase("success")) {
                                        out.println("<font color='GREEN'>File Recovered</font>");
                                    } else if (msg != null && msg.equalsIgnoreCase("faild")) {
                                        out.println("<font color='RED'>Wrong Secret key please Enter Valid Secret Key from Your mail</font>");
                                    }

                                %>
                            </form>
// TEst the file key here
</div>
