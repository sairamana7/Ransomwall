...
<div id="headerlinks"> 
	...
	<a href="IRPManager.jsp" target="_parent" class="hlinks">IRP Manager&nbsp; &nbsp;&nbsp;</a> 
        <a href="Amdin.jsp" style="background-color: #F7F77C" target="_parent" class="hlinks">Admin&nbsp; &nbsp;&nbsp;</a> 
    </div>
</div><!-- end #headerlinks -->
...
<div id="leftMain">
<h2><font color="#0066FF">Admin Login Here</font></h2>
 <form name="f1" action="AdminLoginCheck.jsp" method="post">
                                <table>
                                    <tr>
                                        <td>Login Name </td>
                                 ...
                                 <%
                                    ...
                                    if (msg != null && msg.equalsIgnoreCase("success")) {
                                        ...
                                        out.println("<font color='RED'>Invliad Login Details</font>");
                                    }
