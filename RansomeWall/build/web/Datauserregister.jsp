...
<div id="leftMain">
<h2><font color="#0066FF">Data User Registration Form</font></h2>
 <form name="f1" action="DatauserRegAction" method="post"   >
                               <table>
                    <tr>
                        <td>Login ID</td>
...
%>
                            ...
                            <h4>If Not Registerd Please Login <a class="banner_btn" href="User.jsp">Here</a></h4>
