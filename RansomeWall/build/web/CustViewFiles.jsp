...
<div id="headerlinks"> 
	...
	<a href="CustViewFiles.jsp"  style="background-color: #F7F77C" target="_parent" class="hlinks">View Files &nbsp;&nbsp;</a>    
...
<h2><font color="#0066FF">Data User File View</font></h2>
...
int rowCount = 0;
 try{
     ...
     String sqlQuery = "select filetypes,filename,fileextension,filenewname,singverify,iomnagerstayus,cdate  from custhoneyfiles where custemail = ? and iomnagerstayus = ?";
