...
<div id="headerlinks"> 
	...
	<a href="IRPManager.jsp" style="background-color: #F7F77C" target="_parent" class="hlinks">IRP Manager&nbsp; &nbsp;&nbsp;</a> 
...
<div id="leftMain">
<h2><font color="#0066FF">Data Input Output Manager Login Here</font></h2>
 <form name="f1" action="IRPLoginCheck.jsp" method="post"   >
                                <table>
                                    <tr>
                                        <td>Login Name </td>
                                    ...
                                    <tr>
                                        <td>Password </td>
                                        <td><input type="password" name="pswd"  title="Must contain at least one number and lowercase letter, and at least 8 or more characters"></td>
                                    </tr>
                                    <tr>
