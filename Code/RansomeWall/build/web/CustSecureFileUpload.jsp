...
<div id="headerlinks"> 
    <div align="CENTER" style="font-size: large;">        
        ...
        <a href="CustSecureFileUpload.jsp"  style="background-color: #F7F77C" target="_parent" class="hlinks">Secure File &nbsp;&nbsp;</a>  
	<a href="CustViewFiles.jsp" target="_parent" class="hlinks">View File &nbsp;&nbsp;</a>    
	<a href="CustAttakedFiles.jsp" target="_parent" class="hlinks">Attacked Files&nbsp; &nbsp;&nbsp;</a>         
...
<form action="CustFileUploadAction" method="post" enctype="multipart/form-data">
    <table border="2px">
        <tr>
            <td>File Type</td>
        ...
        <tr>
            <td><label for="fileupload"> Select a file to upload</label></td>
...
<%
                ...
                out.println("<font color='green'>File Uploaded and Send to Input outpuit manager </font>");
                }else if(msg!=null && msg.equalsIgnoreCase("faild")){
                out.println("<font color='RED'>File Not Uploaded Due to Technical Problam</font>");
                }
