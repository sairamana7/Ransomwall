...
<div id="headerlinks"> 
	...
	<a href="AdminRecoveries.jsp"  target="_parent" class="hlinks">User Request&nbsp; &nbsp;&nbsp;</a>        
        <a href="AdminAttackedFiles.jsp" style="background-color: #F7F77C" target="_parent" class="hlinks">Attacked Files&nbsp; &nbsp;&nbsp;</a>        
...
<h2><font color="#0066FF">List of Attacked Files</font></h2>
...
int rowCount = 0;
 try{
     ...
     String sqlQuery = "select * from ransomeattacking";
